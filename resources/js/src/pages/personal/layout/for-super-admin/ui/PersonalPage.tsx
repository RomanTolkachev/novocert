...
const menuItems = [
    ...
    { text: 'Компании', path: '/personal/companies' },
    { text: 'Системы СДС', path: '/personal/systems' },
    { text: 'Органы СДС', path: '/personal/organs' },
    { text: 'Сертификаты СДС', path: '/personal/certs' },
    { text: 'Отзывы компаний', path: '/personal/feedbacks' },
]
