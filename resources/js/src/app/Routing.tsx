...
import { Bio, CertDetails, CompanyDetails, DocDetails, OrganDetails, SystemDetails } from "@/widgets";
    ...
    return (
        <Routes>
            ...
            <Route path="cert_systems" element={<LayoutWithOutlet />}>
                ...
                <Route path=":id" element={<SystemDetails scope="public" />} />
            </Route>
            ...
            <Route path="certs" element={<LayoutWithOutlet />}>
                ...
                <Route path=":id" element={<CertDetails scope="public" />} />
            </Route>
            <Route path="docs" element={<LayoutWithOutlet />}>
                <Route path="" element={<DocsPage />} />
                <Route path=":id" element={<DocDetails scope="public" />} />
            </Route>
            <Route path="companies" element={<LayoutWithOutlet />}>
                <Route path="" element={<CompaniesPage />} />
                <Route path=":id" element={<CompanyDetails scope="public" />} />
            </Route>
            ...
            <Route
                ...
                <Route path="systems" element={<LayoutWithOutlet />}>
                    ...
                    <Route path=":id" element={<SystemDetails scope="admin" />} />
                </Route>
                <Route path="organs" element={<LayoutWithOutlet />}>
                ...
                <Route path="certs" element={<LayoutWithOutlet />}>
                    ...
                    <Route path=":id" element={<CertDetails scope="admin" />} />
                </Route>
